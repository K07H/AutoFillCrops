...
1) Edit the "Config.txt" with:
   ...
   - the option to search for fertilizers in nearby dung beetles inventories or not (by default it is set to "true" so that it searches in nearby dung beetles inventories).
2) Stop server.
